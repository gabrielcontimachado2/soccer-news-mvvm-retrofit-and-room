...
import com.bootcamp.soccernews.databinding.CardNewsFavoriteBinding
...
class FavoriteNewsAdapter : RecyclerView.Adapter<FavoriteNewsAdapter.NewsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsViewHolder {
        val binding = CardNewsFavoriteBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class NewsViewHolder(binding: CardNewsFavoriteBinding) : RecyclerView.ViewHolder(binding.root) {
